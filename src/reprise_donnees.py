...
def maj_old():
    """
    Remplace les anciennes villes (coma, comd) par les nouvelles dans table permutation ville_newId
    :return:
    """
    ...
    df_reprise.to_csv(utils.output.get('reprise_ville'), index=None)
