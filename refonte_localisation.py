...
def refonte(out_to_pdf=False, run_reprise=True):
    ...
    if run_reprise:
        ...
        reprise_donnees.maj_old()

    reprise_check.check_env(env="MOA", enable_print=False, file_txt=utils.report.get('process_txt_method_mysql'))
...
utils.generate_documentation(extend_dev=True)
