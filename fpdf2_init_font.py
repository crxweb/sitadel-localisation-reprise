...
pdf.add_font('gargi', '', '/home/crxadmin/.local/share/fonts/gargi.ttf', uni=True)
...
pdf.add_font('fireflysung', '', '/home/crxadmin/.local/share/fonts/fireflysung.ttf', uni=True)
...
pdf.add_font('eunjin', '', '/home/crxadmin/.local/share/fonts/Eunjin.ttf', uni=True)
pdf.set_font('eunjin', '', 14)
pdf.write(8, u'Korean: 안녕하세요')
pdf.ln(20)

# Add a Fonts-TLWG (formerly ThaiFonts-Scalable) (uses UTF-8)
pdf.add_font('waree', '', '/home/crxadmin/.local/share/fonts/Waree.ttf', uni=True)
